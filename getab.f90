...
!.... write out the eigenvalues
        ...
        write(20,60) REAL(beta), real(eval(jloc)), aimag(eval(jloc))
        
        else    ! extrapolate for the eigenvalue
        
          evalg = eval1 + (eval2-eval1)/(parm2-parm1)*(beta-parm1)
